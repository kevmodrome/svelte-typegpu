<script lang="ts">
  ...
  const hasRenderSettings = $derived(slug === 'occlusion' || slug === 'asset-world' || slug === 'svelte-motion' || slug === 'native-events' || slug === 'shared-stores' || slug === 'reactive-collections');
  ...
  $effect(() => {
    frameloop = slug === 'occlusion' || slug === 'asset-world' || slug === 'gravity' || slug === 'svelte-motion' || slug === 'native-events' || slug === 'shared-stores' || slug === 'reactive-collections' ? 'demand' : 'always';
...
<div class:preview-with-controls={hasControls}>
  <section class="preview-panel" class:preview-asset-world={slug === 'asset-world' || slug === 'occlusion'} class:preview-with-store-controls={slug === 'shared-stores'} class:preview-with-collection-controls={slug === 'reactive-collections'} aria-label={`${label} live preview`}>
    {#key slug}
      {#if slug === 'occlusion' || slug === 'asset-world' || slug === 'native-events' || slug === 'shared-stores' || slug === 'reactive-collections'}
